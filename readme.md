...
- [Applicability Rules](https://docs.microsoft.com/en-us/mem/intune/configuration/device-profile-create#applicability-rules)
- [Protection Configuration Levels](https://learn.microsoft.com/en-us/mem/intune/fundamentals/protection-configuration-levels)
- [Group Policy Analytics](https://docs.microsoft.com/en-us/mem/intune/configuration/group-policy-analytics)
- [Filters](https://docs.microsoft.com/en-us/mem/intune/fundamentals/filters)
- [Filter Performance Recommendations](https://learn.microsoft.com/en-us/mem/intune/fundamentals/filters-performance-recommendations)
...
- [Autopilot Troubleshooting FAQ](https://learn.microsoft.com/en-us/autopilot/troubleshooting-faq#troubleshooting-windows-autopilot-overview)
- [Troubleshoot ESP](https://learn.microsoft.com/en-us/troubleshoot/mem/intune/device-enrollment/understand-troubleshoot-esp)
- [Autopilot Deep Dive Blog](https://oofhours.com/2019/10/08/troubleshooting-windows-autopilot-a-reference/)
- [Android Zero-Touch Enrollment](https://learn.microsoft.com/en-us/mem/intune/enrollment/android-dedicated-devices-fully-managed-enroll#enroll-by-using-google-zero-touch)
- [Apple DEP Enrollment](https://docs.microsoft.com/en-us/mem/intune/enrollment/device-enrollment-program-enroll-ios)
...
- [Send Logs from iOS](https://docs.microsoft.com/en-us/mem/intune/user-help/send-logs-to-microsoft-iOS)
